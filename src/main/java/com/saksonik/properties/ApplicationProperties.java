...
public class ApplicationProperties {
    ...
    public static String SHARED_KEY_BETWEEN_CLIENT_AND_GRANTED_SERVER = "9mng65v8jf4lxn93nabf981m";
    public static String SHARED_KEY_BETWEEN_AUTH_AND_GRANTED_SERVERS = "9mng65v8jf4lxn93nabf981m";
